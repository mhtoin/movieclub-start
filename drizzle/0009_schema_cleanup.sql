...
ALTER TABLE "raffle" ADD CONSTRAINT "raffle_winningMovieId_movie_id_fk" FOREIGN KEY ("winningMovieId") REFERENCES "public"."movie"("id") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint

-- Step 6: Add createdAt to key tables (defaults to NOW() for existing rows)
ALTER TABLE "movie" ADD COLUMN "createdAt" timestamp(3) NOT NULL DEFAULT NOW();--> statement-breakpoint
ALTER TABLE "review" ADD COLUMN "createdAt" timestamp(3) NOT NULL DEFAULT NOW();--> statement-breakpoint
ALTER TABLE "raffle" ADD COLUMN "createdAt" timestamp(3) NOT NULL DEFAULT NOW();--> statement-breakpoint
ALTER TABLE "tierlist" ADD COLUMN "createdAt" timestamp(3) NOT NULL DEFAULT NOW();--> statement-breakpoint
ALTER TABLE "recommended_movie" ADD COLUMN "createdAt" timestamp(3) NOT NULL DEFAULT NOW();--> statement-breakpoint
