        ...
        {open && (
          <>
            ...
            <button
              type="button"
              aria-label="Close"
              className="fixed inset-0 z-[101] flex items-center justify-center p-4 appearance-none border-none bg-transparent cursor-pointer"
              onClick={() => onOpenChange(false)}
            >
              <m.div
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-muted/30">
                  <div className="flex items-center gap-3">
                    {user.image ? (
                      ...
                      <div className="size-10 rounded-full border-2 border-border bg-muted flex items-center justify-center font-bold text-sm">
