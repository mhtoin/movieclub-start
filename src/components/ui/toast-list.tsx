  ...
  return toasts.map((toast) => (
    ...
    >
      <Toast.Content className="overflow-hidden transition-opacity [transition-duration:250ms] data-[behind]:pointer-events-none data-[behind]:opacity-0 data-[expanded]:pointer-events-auto data-[expanded]:opacity-100">
        <Toast.Title className="text-[0.975rem] leading-5 font-medium text-foreground" />
        <Toast.Description className="text-[0.925rem] leading-5 text-foreground" />
        <Toast.Close
          className="absolute top-2 right-2 flex h-5 w-5 items-center justify-center rounded border-none bg-transparent text-foreground hover:bg-gray-100 hover:text-gray-700"
          aria-label="Close"
        >
