      ...
      >
        ...
        <div className="flex items-center gap-3 relative z-10">
          <div className="relative flex-shrink-0">
            {isAllUsers ? (
              <div className="size-10 rounded-full border-2 shadow-md flex items-center justify-center text-2xl transition-all duration-300 border-border group-data-[selected]/tab:border-primary group-data-[selected]/tab:bg-primary/10">
              ...
              <img
                src={imageUrl}
                alt={name}
                className="size-10 rounded-full border-2 shadow-md transition-all duration-300 border-border group-data-[selected]/tab:border-primary group-data-[selected]/tab:shadow-primary/30"
              />
            )}
            <div className="absolute -bottom-0.5 -right-0.5 size-3 bg-primary rounded-full border-2 border-card transition-transform group-data-[selected]/tab:scale-125" />
          </div>
